...
public class ConversionTrackersPage {
    ...
    /*@FindBy(how= How.CSS,using="div[class='searchable-select-single'] dropdown div[class='dropdown'] div[class^='dropdown--container']")
    public WebElement _Advertiser_Lists;*/
    @FindBy(how= How.CSS,using="div[class='searchable-select-single'] dropdown div[class='dropdown'] div[class^='dropdown--container'] div div ul li")
    public WebElement _Advertiser_Lists;
   ...
   /* @FindBy(how= How.CSS,using="div[class='searchable-select-single'] dropdown div[class='dropdown'] div[class^='dropdown--container'] div div ul li")
    ...
    public String _CreateTracker_Button=".button--primary";
